...
func (m *mockTokenService) Create(ctx context.Context, user entity.User) (string, string, error) {
	args := m.Called(ctx, user)

	return args.String(0), args.String(0), nil
}

func (m *mockUserRepository) FindByEmail(ctx context.Context, mail string) (entity.User, error) {
...
func TestLogin(t *testing.T) {
	...
	objUserRepository.On("FindByEmail", ctx, "admin@mail.com").Return(entity.User{ID: "xys", Name: "admin", Email: "admin@mail.com", Password: utils.Bcrypt("Password1")}, nil)
